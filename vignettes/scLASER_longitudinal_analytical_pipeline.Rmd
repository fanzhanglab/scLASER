---
title: "Tutorial: applying scLASER to identify time-dependent cell dynamics on simulated three-timepoints single-cell data"
author: |
...
```{r}
obj <- scLASER(metadata = readRDS("C:\\Users\\Juan\\Documents\\GitHub\\scLASER\\sim_data_lv.rds"), pcs = readRDS("C:\\Users\\Juan\\Documents\\GitHub\\scLASER\\sim_pcs_lv.rds"))

obj
plot_celltype_proportions(
  obj,
  disease_var = "disease",
  disease_labels = c("0" = "Non-converter", "1" = "Responder"),
  disease_colors = c("Non-converter" = "#4DAF4A", "Responder" = "#984EA3")
)
```
