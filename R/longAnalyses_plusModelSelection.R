#' Longitudinal mixed-model selection across NAM PCs
#'
#' Internal helper used by exported wrappers (e.g., scLASER_modeling). Fits three
#' candidate nlme::lme models per NAM PC (continuous, categorical, quadratic time),
#' selects best by AIC, and computes an LRT vs a matched null without interaction.
#'
